...
# DNN tuned for tabular financial data (~500-800 rows)
# Smaller network = less overfitting on limited data
DNN_PARAMS = {
    "hidden_layers": [32, 16],    # small network for small data
    "dropout": 0.2,               # lighter regularisation
    "learning_rate": 5e-4,        # slower, more stable
    "epochs": 300,                # more room, early stopping will cut
    "batch_size": 32,             # smaller batches = more gradient updates
    "patience": 30,               # give it time to converge
}
